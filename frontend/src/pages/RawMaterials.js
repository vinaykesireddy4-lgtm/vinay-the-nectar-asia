...
const RawMaterials = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editingMaterial) {
        await axios.put(`${API}/raw-materials/${editingMaterial.id}`, data);
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-gray-500 mt-1">Manage raw materials inventory with stock tracking</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
            <p className="text-sm text-gray-500 mb-1">Total Raw Materials</p>
        ...
        <div className="p-4 border-b border-gray-200">
          <div className="relative">
            ...
            <Input
              ...
              className="pl-10"
              data-testid="search-raw-materials-input"
            />
          </div>
        </div>
                  ...
                  <tr key={material.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <button
                        ...
                        data-testid={`edit-raw-material-${material.id}`}
                      >
                      ...
                      <button
                        ...
                        data-testid={`delete-raw-material-${material.id}`}
                      >
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent data-testid="raw-material-dialog" aria-describedby="raw-material-dialog-description">
          <DialogHeader>
            <DialogTitle>
              {editingMaterial ? 'Edit Raw Material' : 'Add New Raw Material'}
            </DialogTitle>
            <p id="raw-material-dialog-description" className="sr-only">
              Form to add or edit raw material details including stock
            </p>
          </DialogHeader>
          <form onSubmit={handleSubmit}>
            <div className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  required
                  data-testid="raw-material-name-input"
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  data-testid="raw-material-hsn-input"
                />
              </div>
              <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    data-testid="raw-material-stock-input"
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    data-testid="raw-material-min-stock-input"
                  />
                </div>
              </div>
            </div>
            <DialogFooter className="mt-6">
              ...
              <Button type="submit" className="bg-indigo-600 hover:bg-indigo-700" data-testid="save-raw-material-btn">
