  ...
  return (
    <div className="p-8">
      <div className="mb-8 flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Payment Made</h1>
          <p className="text-gray-500 mt-1">Track payments made to suppliers</p>
        </div>
        <Button
          onClick={() => navigate('/create-payment-made')}
        ...
        <div className="p-4 border-b border-gray-200">
          <div className="flex gap-4">
            <div className="flex-1 relative">
              ...
              <Input
                placeholder="Search by supplier or payment number..."
                value={searchTerm}
